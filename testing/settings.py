"""
Django settings for bio_portal project.
...
from bio_portal.apps import SEARCH_INDEXES  # noqa
...
TEMPLATES = [
    {
        ...
        "DIRS": [BASE_DIR / "bio_portal" / "templates"],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
LOGGING = {
    ...
    "loggers": {
        ...
        "bio_portal": {"handlers": ["stream"], "level": "INFO"},
    },
}
